...
# response = RestClient.post "http://localhost:3000/api/v1/sports_centres/1/bookings", {"Token": "ojYhT7iWiCwgTgGVTuQdrXsvHzTb%2BNoe"}, {content_type: "application/x-www-form-urlencoded"}
...
response = RestClient.post "https://poliapi.apac.paywithpoli.com/api/v2/Transaction/Initiate", {Amount: "1.2", CurrencyCode: "AUD", MerchantReference:"CustomerRef12345",
    ...
    SuccessURL:"https://6328da3e.ngrok.io/api/v1/sports_centres/1/bookings",
