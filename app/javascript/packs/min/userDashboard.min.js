...
goog.TRUSTED_TYPES_POLICY_NAME?goog.createTrustedTypesPolicy(goog.TRUSTED_TYPES_POLICY_NAME+"#base"):null,goog.global.CLOSURE_NO_DEPS||goog.debugLoader_.loadClosureDeps(),goog.bootstrap=function(a,b){goog.debugLoader_.bootstrap(a,b)});goog.TRUSTED_TYPES_POLICY_NAME="";goog.identity_=function(a){return a};goog.createTrustedTypesPolicy=function(a){var b=null,c=goog.global.trustedTypes;if(!c||!c.createPolicy)return b;try{b=c.createPolicy(a,{createHTML:goog.identity_,createScript:goog.identity_,createScriptURL:goog.identity_})}catch(d){goog.logToConsole_(d.message)}return b};$(document).ready(function(){$("a").on("click",function(a){if(""!==this.hash){a.preventDefault();var b=this.hash;$("html, body").animate({scrollTop:$(b).offset().top},800,function(){window.location.hash=b})}})});document.addEventListener("turbolinks:load",function(){$('[data-toggle="tooltip"]').tooltip()});
document.addEventListener("DOMContentLoaded",function(){if(0<$(".book-now").length){var a=function(a){var c=0,e=document.querySelectorAll(".priceHolder");for(a="data-"+a+"-price";c<e.length;)b=e[c].getAttribute(a),e[c].innerHTML=b,c++};document.querySelector(".casual");document.querySelector(".regular");var b;$("body").on("click",".casual",function(){a("casual")});$("body").on("click",".regular",function(){a("regular")})}});
document.addEventListener("DOMContentLoaded",function(){if(1!=$("#weBallWidget").length){var a=new Date;$('[data-provide="datepicker"]').datepicker({format:"DD, d MM yyyy",todayHighlight:!0,autoclose:!0,clearBtn:!0,startDate:a.toLocaleDateString(),maxViewMode:"years"}).on("changeDate",function(a){a=a.date;$("#my_hidden_input").val(a);a=a.toLocaleDateString().split("/");a=a[2]+"-"+a[1]+"-"+a[0];document.querySelector(".dateHolder").setAttribute("data-date",a);var b=document.querySelector(".slideHolder").dataset.centre;
$.ajax({type:"GET",url:"/sports_centres/"+b+"/"+a,data:{},success:function(a){alert("ok, change date working!")},error:function(a){alert("error")}})})}$("td.active.day").trigger("click");$("body").on("click",'[data-toggle="dropdown"]',function(){$(".dropdown-toggle").dropdown()});$("#homeBody").on("click","button.tooltipTarget",function(){$(this).find(".tooltiptext").css("visibility","visible").delay(1E3).fadeOut();$(this).find(".tooltiptext").css("display","block");var a=$(this).attr("data-target");
a=document.getElementById(""+a);console.log(a);a.select();a.setSelectionRange(0,99999);document.execCommand("copy");a.blur()})});
