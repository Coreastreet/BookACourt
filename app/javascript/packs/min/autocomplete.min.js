...
*/
var COMPILED=!0,goog=goog||{};goog.global=this||self;goog.exportPath_=function(a,b,c){a=a.split(".");c=c||goog.global;a[0]in c||"undefined"==typeof c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)a.length||void 0===b?c=c[d]&&c[d]!==Object.prototype[d]?c[d]:c[d]={}:c[d]=b};
...
goog.TRUSTED_TYPES_POLICY_NAME?goog.createTrustedTypesPolicy(goog.TRUSTED_TYPES_POLICY_NAME+"#base"):null,goog.global.CLOSURE_NO_DEPS||goog.debugLoader_.loadClosureDeps(),goog.bootstrap=function(a,b){goog.debugLoader_.bootstrap(a,b)});goog.TRUSTED_TYPES_POLICY_NAME="";goog.identity_=function(a){return a};goog.createTrustedTypesPolicy=function(a){var b=null,c=goog.global.trustedTypes;if(!c||!c.createPolicy)return b;try{b=c.createPolicy(a,{createHTML:goog.identity_,createScript:goog.identity_,createScriptURL:goog.identity_})}catch(d){goog.logToConsole_(d.message)}return b};$(document).on("turbolinks:load",function(){var a=document.querySelector("#autocomplete"),b={street_number:"short_name",route:"long_name",locality:"long_name",administrative_area_level_1:"short_name",postal_code:"short_name"},c=new google.maps.places.Autocomplete(a,{types:["establishment"],componentRestrictions:{country:"au"}});c.setFields("address_components adr_address formatted_address geometry icon name permanently_closed photo place_id plus_code type url utc_offset vicinity".split(" "));google.maps.event.addListener(c,
"place_changed",function(){var a=c.getPlace();console.log(a.address_components);var e=a.name;$("#title").val(e);document.getElementById("street_address").value="";for(e=0;e<a.address_components.length;e++){var f=a.address_components[e].types[0];if(b[f])if("street_number"==f||"route"==f){console.log(e);var g=a.address_components[e][b[f]]+" ";document.getElementById("street_address").value+=g}else g=a.address_components[e][b[f]],document.getElementById(f).value=g}})}); 
