...
goog.TRUSTED_TYPES_POLICY_NAME?goog.createTrustedTypesPolicy(goog.TRUSTED_TYPES_POLICY_NAME+"#base"):null,goog.global.CLOSURE_NO_DEPS||goog.debugLoader_.loadClosureDeps(),goog.bootstrap=function(a,b){goog.debugLoader_.bootstrap(a,b)});goog.TRUSTED_TYPES_POLICY_NAME="";goog.identity_=function(a){return a};goog.createTrustedTypesPolicy=function(a){var b=null,c=goog.global.trustedTypes;if(!c||!c.createPolicy)return b;try{b=c.createPolicy(a,{createHTML:goog.identity_,createScript:goog.identity_,createScriptURL:goog.identity_})}catch(d){goog.logToConsole_(d.message)}return b};document.addEventListener("DOMContentLoaded",function(){if(null!=document.querySelector("canvas")){$("body").on("click",".card-columns div.card",function(a){a=$(this).data("id");$(".slideHolder").addClass("show");$(".slideHolder").attr("data-centre",a);var b=c.toLocaleDateString().split("/");$.ajax({type:"GET",url:"/sports_centres/"+a+"/user_show",data:{date:b[2]+"-"+b[1]+"-"+b[0]},success:function(a){a=c.toLocaleDateString("en-us",{month:"long"});a=c.toLocaleDateString("en-us",{weekday:"long"})+
", "+c.getDate()+" "+a+" "+c.getFullYear();document.querySelector("input.form-control").value=a},error:function(a){alert()}})});var a=document.querySelector("canvas"),b=document.querySelector(".below-clock");a.height=b.clientWidth;a.width=b.clientWidth;b=a.getContext("2d");a=a.height/2;b.translate(a,.9*a);var c=new Date,d;var e=c.toLocaleDateString("en-GB",{weekday:"long",day:"numeric",month:"long"});$(".startDate").val(e);console.log(e);$('[data-provide="datepicker"]').datepicker({format:"DD, d MM yyyy",
todayHighlight:!0,autoclose:!0,startDate:c.toLocaleDateString(),maxViewMode:"years"}).on("changeDate",function(a){e=$(this).datepicker("getFormattedDate");d=e.lastIndexOf(" ");e=e.substring(0,d);$(".startDate").val(e)})}},!1);
