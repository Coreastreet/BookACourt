...
goog.TRUSTED_TYPES_POLICY_NAME?goog.createTrustedTypesPolicy(goog.TRUSTED_TYPES_POLICY_NAME+"#base"):null,goog.global.CLOSURE_NO_DEPS||goog.debugLoader_.loadClosureDeps(),goog.bootstrap=function(a,b){goog.debugLoader_.bootstrap(a,b)});goog.TRUSTED_TYPES_POLICY_NAME="";goog.identity_=function(a){return a};goog.createTrustedTypesPolicy=function(a){var b=null,c=goog.global.trustedTypes;if(!c||!c.createPolicy)return b;try{b=c.createPolicy(a,{createHTML:goog.identity_,createScript:goog.identity_,createScriptURL:goog.identity_})}catch(d){goog.logToConsole_(d.message)}return b};document.addEventListener("DOMContentLoaded",function(){(function(a,b){(function(a,b){var c=document.createElement("script");c.async=!0;c.src=a;a=document.getElementsByTagName("script")[0];a.parentNode.insertBefore(c,a);c.onload=c.onreadystatechange=function(){if(!c.readyState||/complete|loaded/.test(c.steadyState))b(),c.onload=null,c.onreadystatechange=null}})("https://weball.com.au/jquery.js",function(){var a=a||{};a.$=a.jQuery=jQuery.noConflict(!0);a:{a=document.getElementsByTagName("script");
for(var b,e=0;e<a.length;e++)if(b=a[e].getAttribute("data-sports-centre-id")){a=b;break a}a=null}alert(a.id)});return{}})(window)});
