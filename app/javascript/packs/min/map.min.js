...
goog.TRUSTED_TYPES_POLICY_NAME?goog.createTrustedTypesPolicy(goog.TRUSTED_TYPES_POLICY_NAME+"#base"):null,goog.global.CLOSURE_NO_DEPS||goog.debugLoader_.loadClosureDeps(),goog.bootstrap=function(a,b){goog.debugLoader_.bootstrap(a,b)});goog.TRUSTED_TYPES_POLICY_NAME="";goog.identity_=function(a){return a};goog.createTrustedTypesPolicy=function(a){var b=null,c=goog.global.trustedTypes;if(!c||!c.createPolicy)return b;try{b=c.createPolicy(a,{createHTML:goog.identity_,createScript:goog.identity_,createScriptURL:goog.identity_})}catch(d){goog.logToConsole_(d.message)}return b};document.addEventListener("DOMContentLoaded",function(){if(null!=document.querySelector("#mapid")){var a=function(a){c=a.coords.latitude;d=a.coords.longitude;e=L.map("mapid").setView([c,d],13);L.tileLayer("https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiY29yZWFzdHJlZXQiLCJhIjoiY2szZTA5N3RkMWY2NTNkbzFibWVyMTBqZiJ9.Cu4QOakswmv-NyeoW-twrQ",{attribution:'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery \u00a9 <a href="https://www.mapbox.com/">Mapbox</a>',
maxZoom:18,id:"mapbox.streets",accessToken:"pk.eyJ1IjoiY29yZWFzdHJlZXQiLCJhIjoiY2szZTA5N3RkMWY2NTNkbzFibWVyMTBqZiJ9.Cu4QOakswmv-NyeoW-twrQ"}).addTo(e);f=L.marker([c,d]).addTo(e)},b=window.GeoSearch.GeoSearchControl,c,d,e,f,g=new window.GeoSearch.OpenStreetMapProvider;new b({provider:g});navigator.geolocation?navigator.geolocation.getCurrentPosition(a):alert("Geolocation is not supported by this browser.");var k=document.querySelectorAll(".card-columns .card-title");a=document.querySelectorAll(".card-columns .card-address");
var h=[],l=[];for(b=0;b<a.length;b++)h.push(a[b].innerText),l.push(k[b].innerText);var m;l=function(a){g.search({query:h[a]}).then(function(b){0!=b.length?(d=b[0].x,c=b[0].y,f=L.marker([c,d]).addTo(e),m="<b>"+k[a].innerText+"</b><br>"+h[a],f.bindPopup(m)):console.log("cannot bind pop-up")}).catch(function(a){console.log(a.message+"Error occurred")})};for(b=0;b<a.length;b++)l(b)}});
