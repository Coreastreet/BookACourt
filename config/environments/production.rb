Rails.application.configure do
  ...
  # config.action_cable.url = 'wss://weball.com.au'
  config.action_cable.allowed_request_origins = [/https:\/\/weball.com.au\/.*/]
  ...
  cache_server = "redis://localhost:6379/0/cache"
  config.cache_store = :redis_cache_store, { url: cache_server }

  # Use a real queuing backend for Active Job (and separate queues per environment).
  # config.active_job.queue_adapter     = :resque
  # config.active_job.queue_name_prefix = "BookACourt_production"
