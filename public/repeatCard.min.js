...
goog.TRUSTED_TYPES_POLICY_NAME?goog.createTrustedTypesPolicy(goog.TRUSTED_TYPES_POLICY_NAME+"#base"):null,goog.global.CLOSURE_NO_DEPS||goog.debugLoader_.loadClosureDeps(),goog.bootstrap=function(a,b){goog.debugLoader_.bootstrap(a,b)});goog.TRUSTED_TYPES_POLICY_NAME="";goog.identity_=function(a){return a};goog.createTrustedTypesPolicy=function(a){var b=null,c=goog.global.trustedTypes;if(!c||!c.createPolicy)return b;try{b=c.createPolicy(a,{createHTML:goog.identity_,createScript:goog.identity_,createScriptURL:goog.identity_})}catch(d){goog.logToConsole_(d.message)}return b};var bw=BookingWidget.$("#BookingWidget"),mainClockCard=BookingWidget.$("#BookingWidget #clockHolderCard"),repeatCard=BookingWidget.$("#BookingWidget #repeatBookingCard");mainClockCard.find("#bw-brand").on("load",function(){var a=mainClockCard.find("#bw-brandRow").innerHeight();a=mainClockCard.outerHeight()-a;repeatCard.height(a);repeatCard.css("margin-top","-"+a+"px")});
mainClockCard.find("#bw-brand").on("error",function(){var a=mainClockCard.find("#bw-brandRow").innerHeight();a=mainClockCard.outerHeight()-a;repeatCard.height(a);repeatCard.css("margin-top","-"+a+"px")});bw.on("click","#repeatButton",function(){repeatCard.css("margin-left","0%")});
bw.on("click",".days-and-weeks button",function(){var a=BookingWidget.$(this).closest(".form-row").find("input"),b=a.val();BookingWidget.$(this).addClass("btn-selected");BookingWidget.$(this).siblings().not(BookingWidget.$(this)).removeClass("btn-selected");"Days"==BookingWidget.$(this).attr("data-frequency-type")?(a.attr("placeholder","Every Day"),a.attr("data-frequency-type","Days"),0<b.length&&a.val(b.replace("Week","Day"))):(a.attr("placeholder","Every Week"),a.attr("data-frequency-type","Weeks"),
0<b.length&&a.val(b.replace("Day","Week")))});
bw.on("click",".addAndMinus .minus-button",function(){number=parseInt(BookingWidget.$(this).next().text());0<number&&(--number,BookingWidget.$(this).next().text(number),input=BookingWidget.$(this).closest(".form-row").find("input"),inputArray=input.attr("placeholder").split(" "),inputString=1==number?BookingWidget.$(this).closest(".form-row").hasClass("frequency")?inputArray[0]+" "+inputArray[inputArray.length-1]:inputArray[0]+" "+number+" "+inputArray[inputArray.length-1]:inputArray[0]+" "+number+
" "+inputArray[inputArray.length-1]+"s",input.val(inputString))});
bw.on("click",".addAndMinus .plus-button",function(){number=parseInt(BookingWidget.$(this).prev().text());52>number&&(number+=1,BookingWidget.$(this).prev().text(number),input=BookingWidget.$(this).closest(".form-row").find("input"),inputArray=input.attr("placeholder").split(" "),console.log(inputArray),inputString=1==number?BookingWidget.$(this).closest(".form-row").hasClass("frequency")?inputArray[0]+" "+inputArray[inputArray.length-1]:inputArray[0]+" "+number+" "+inputArray[inputArray.length-1]:
inputArray[0]+" "+number+" "+inputArray[inputArray.length-1]+"s",input.val(inputString))});bw.on("click",".back-arrow-booking",function(){BookingWidget.$(this).closest(".card").css("margin-left","100%")});repeatCard=bw.find("#repeatBookingCard");repeatCard.on("click","#frequencyRow button",function(){uncheckAvailability()});
function uncheckAvailability(){var a=repeatCard.find("#maxBookingsWarning");a.text("");a.attr("data-arrayOfFreeCourtIds","");a.attr("data-maxBookings","1");repeatCard.attr("data-availabilityChecked","false")};
