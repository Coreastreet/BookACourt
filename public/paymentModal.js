...
bw.on("click", "#bookNowButton", function(e) {
  ...
  if (  ( firstInputValue == '') || ( firstInputValue.substr(-2) == ("30" || "00") ) || (firstInputValue < firstInput.attr("min")) ||
        (firstInputValue < nowHHSS) || (firstInputValue > firstInput.attr("max"))  ) {

        firstInput.css("border-color", "red");
        inputError = true;
  }
  if (  ( secondInputValue == '') || ( secondInputValue.substr(-2) == ("30" || "00") ) || (secondInputValue < secondInput.attr("min")) ||
